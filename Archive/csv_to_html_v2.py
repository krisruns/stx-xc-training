...
Usage: python csv_to_html_v2.py week12_schedule.csv
"""
...
<head>
    ...
    <title>STX XC Week {week_num} Training</title>
    <style>
...
<body>
    <h1>🏃 STX XC Training - Week {week_num}</h1>
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python csv_to_html_v2.py <csv_file>")
        sys.exit(1)
    ...
    week_num = match.group(1) if match else '12'
